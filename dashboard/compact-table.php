          ...
          <table id="fresh-table" class="table">
            ...
            <?php
                              ...
                              die(print_r(sqlsrv_errors(),TRUE));
                                  ...
                                  $sql00 = "SELECT dbo.tblService.ServiceID, dbo.tblService.ServiceDate, dbo.tblCustOrders.OrderNo FROM dbo.tblService INNER JOIN dbo.tblCustOrders ON dbo.tblService.OrderID = dbo.tblCustOrders.OrderID";
