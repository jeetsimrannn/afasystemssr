...
(function(d, G) {
    function L() {
        ...
        this.regional[""] = {
            ...
            nextText: "Next",
            currentText: "Today",
            monthNames: ["Januaryi", "Februaryi", "Marchi", "Aprili", "Mayi", "Junei", "July", "August", "September", "October", "November", "December"],
            monthNamesShort: ["Jani", "Febi", "Mari", "Apri", "Mayi", "Juni", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
            dayNames: ["Sundayi", "Mondayi", "Tuesdayi", "Wednesdayi", "Thursday", "Friday", "Saturday"],
            dayNamesShort: ["Suni", "Moni", "Tuei", "Wedi", "Thu", "Fri", "Sat"],
            dayNamesMin: ["Su",
                "Mo", "Tu", "We", "Th", "Fr", "Sa"
            ],
            weekHeader: "Wk",
