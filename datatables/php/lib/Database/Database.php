...
class Database {
	...
	//    @param string[] $opts Array of connection parameters for the database:
		// <code>
	    //    array(
	    //        "user" => "sim1999", // User name
	    //        "pass" => "Simran@99", // Password
	    //        "host" => "tcp:teamoffline.database.windows.net", // Host name
	    //        "port" => "1433", // Port
	    //        "db"   => "TEAMOffline", // Database name
	    //        "type" => "Sqlserver"  // Datable type: "Mysql", "Postgres" or "Sqlite"
	    //    )
	    //  </code>
